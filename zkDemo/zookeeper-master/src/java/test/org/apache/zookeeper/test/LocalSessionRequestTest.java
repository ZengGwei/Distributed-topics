...
public class LocalSessionRequestTest extends ZKTestCase {
    ...
    /**
     * Test that a CloseSession request generated by both the provider (consumer
     * disconnect) or by the consumer (consumer explicitly issue close()) doesn't
    ...
    public void testOpenCloseSession(boolean onLeader) throws Exception {
        ...
        // Cut the connection, so the provider will create closeSession as part
